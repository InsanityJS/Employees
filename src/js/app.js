    ...
    $scope.employees = [
        {
            ...
            department: "Designer",
            textarea: 'Freddie Mercury (born Farrokh Bulsara; 5 September 1946 – 24 November 1991)[2] was a British singer, songwriter, record producer, and lead vocalist of the rock band Queen. Regarded as one of the greatest singers in the history of rock music, he was known for his flamboyant stage persona and four-octave vocal range. Mercury defied the conventions of a rock frontman, with his highly theatrical style influencing the artistic direction of Queen.',
        },
        {
            id: 1,
            username: "Roger Meddows Taylor",
            department: "Biologist",
            textarea: 'Roger Meddows Taylor OBE (born 26 July 1949) is an English musician, singer-songwriter and multi-instrumentalist, best known as the drummer for the rock band Queen.[1] As a drummer, Taylor was recognised early in his career for his unique sound.[2] He was voted by radio listeners as the eighth-greatest drummer in classic rock music history in a poll conducted by Planet Rock in 2005.[3]',
        },
        {
            id: 2,
            username: "John Deacon",
            department: "Electronic engineer",
            textarea: "John Richard Deacon (born 19 August 1951) is an English retired musician, best known for being the bassist for the rock band Queen. He composed several songs for the group, including Top 10' hits 'You're My Best Friend', 'Another One Bites the Dust', and 'I Want to Break Free' co-wrote 'Under Pressure', 'Friends Will Be Friends' and 'One Vision', and he was involved in the bands financial management",
        },
        {
            id: 3,
            username: "Brian May",
            department: "Astrophysicist",
            textarea: 'Brian Harold May CBE (born 19 July 1947) is an English musician, singer, songwriter, record producer, author, astrophysicist, and university administrator. He is the lead guitarist of the rock band Queen. May is widely regarded as one of the greatest guitarists of all time.',
        },
        {
            id: 4,
            username: "John Peel",
            department: "Journalist",
            textarea: 'John Robert Parker Ravenscroft OBE (30 August 1939 – 25 October 2004), known professionally as John Peel, was an English disc jockey, radio presenter, record producer and journalist. He was the longest-serving of the original BBC Radio 1 DJs, broadcasting regularly from 1967 until his death in 2004.',
        },
    ];
    ...
    $scope.showConfirm = function (ev) {
        var confirm = $mdDialog
            ...
            $mdDialog.show(confirm).then(function (item) {
                $scope.employees.splice($scope.employees.indexOf(item), 1);
                }, function () {
                return;
              });
    };
